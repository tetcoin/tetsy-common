...
- Remove `ElasticArray` and use the new `DBValue` (alias for `Vec<u8>`) and `DBKey` types from `tetsy_kvdb`. (See [PR #282](https://github.com/paritytech/parity-common/pull/282/files))
